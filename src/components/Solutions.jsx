...
//       <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-8xl mx-auto py-16 px-4  rounded-lg border">
//         {solutions.map((solution, index) => (
//           <div
//             key={index}
//             className=" shadow-sm rounded-md overflow-hidden bg-white flex flex-col max-w-4xl py-16 px-4  border"
//           >
//             <img
//               src={solution.image}
//               alt={solution.title}
...
const Solutions = () => {
  return (
    <section className=" px-4 bg-transparent ">
      <div className="max-w-5xl mx-auto text-center mb-12 ">
        <h2 className="text-3xl md:text-6xl font-bold text-[#006BF4]">
          Solutions
        </h2>
       
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-8xl mx-auto py-10 px-16 rounded-lg ">
        {solutions.map((solution, index) => (
          <div
            key={index}
            className="shadow-sm rounded-md overflow-hidden bg-slate-50 flex flex-col max-w-4xl py-10 px-4"
          >
            <img
              src={solution.image}
              alt={solution.title}
              className="w-full h-30 object-cover rounded-2xl mb-4"
            />
            <div className="p-6 flex flex-col flex-grow">
              <h3 className="text-xl font-semibold text-[#006BF4] mb-3">
                {solution.title}
              </h3>
              <p className="text-gray-700 flex-grow">{solution.description}</p>
              <a
